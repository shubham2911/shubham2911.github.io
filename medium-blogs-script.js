 $(function () {
            ...
            var data = {
                rss: 'https://medium.com/feed/@shubham2911'
            };
            $.get(' https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fmedium.com%2Ffeed%2F%40shubham2911', data, function (response) {
                if (response.status == 'ok') {
                    ...
                    $.each(response.items, function (k, item) {
                        ...
                        display += `<a href="${item.link}" target="_blank" class="btnb4 btnb4-outline-success" >Read More</a>`;
                        display += '</div></div>';
                        return k < 10;
                    });
